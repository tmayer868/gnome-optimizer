...
# ----------------------------------------------------------------------
# Model — a small CIFAR-style ResNet family (GELU + GroupNorm/BN)
# ----------------------------------------------------------------------
...
# stages, `blocks[i]` basic blocks per stage at `channels[i]` (first block
# of a stage carries `strides[i]`), global-average-pool, Linear head. The
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--model", choices=list(_SPECS), default="resnet12",
